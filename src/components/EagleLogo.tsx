export const EagleLogo = ({ size = 'lg' }: { size?: 'sm' | 'lg' }) => {
  if (size === 'sm') {
    return (
      <svg viewBox="0 0 48 32" xmlns="http://www.w3.org/2000/svg" className="w-9 h-6 flex-shrink-0" style={{ filter: 'drop-shadow(0 0 8px rgba(30,127,212,0.6))' }}>
        <defs>
          <linearGradient id="wls" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#1e7fd4" /><stop offset="100%" stopColor="#0d5aa8" /></linearGradient>
          <linearGradient id="wrs" x1="100%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#e8621a" /><stop offset="100%" stopColor="#c44810" /></linearGradient>
          <linearGradient id="bds" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#d4dde8" /><stop offset="100%" stopColor="#8fa3be" /></linearGradient>
        </defs>
  ...
  return (
    <svg viewBox="0 0 120 80" xmlns="http://www.w3.org/2000/svg" className="w-[88px] h-[60px]" style={{ filter: 'drop-shadow(0 0 16px rgba(30,127,212,0.55)) drop-shadow(0 0 8px rgba(232,98,26,0.35))', animation: 'float 4s ease infinite' }}>
      <defs>
        <linearGradient id="wl" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#1e7fd4" /><stop offset="100%" stopColor="#0d5aa8" /></linearGradient>
        <linearGradient id="wr" x1="100%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#e8621a" /><stop offset="100%" stopColor="#c44810" /></linearGradient>
        <linearGradient id="bd" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#d4dde8" /><stop offset="100%" stopColor="#8fa3be" /></linearGradient>
      </defs>
