...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center p-4">
      <form
        onSubmit={submit}
        className="w-full max-w-[380px] bg-s1 border border-blue rounded-2xl p-6"
      >
        <div className="font-display text-lg font-bold tracking-[.06em] mb-4">Reset Password</div>
        {!ready && (
          <div className="text-[12px] text-t3 font-mono mb-3">
        ...
        <button
          disabled={!ready}
          className="w-full py-2.5 rounded-lg gradient-sky text-primary-foreground font-display text-sm font-bold tracking-[.06em] uppercase glow-sky disabled:opacity-50"
        >
          Update password
        </button>
